...
| emp_id               | character varying        | string (max length 20)  | true     |
| name                 | character varying        | string (max length 100) | true     |
| designation          | character varying        | string (max length 100) | true     |
| date_of_joining      | date                     | string                  | true     |
| phone_no             | character varying        | string (max length 20)  | true     |
| email                | character varying        | string (max length 100) | true     |
| address              | text                     | string                  | false    |
| dob                  | date                     | string                  | false    |
| emergency_contact_no | character varying        | string (max length 20)  | false    |
| created_at           | timestamp with time zone | string                  | false    |
| updated_at           | timestamp with time zone | string                  | false    |
| created_by           | character varying        | string (max length 100) | false    |
| updated_by           | character varying        | string (max length 100) | false    |
...
|-----------------|--------------------------|-------------------------|----------|
| user_id         | uuid                     | uuid                    | true     |
| username        | character varying        | string (max length 50)  | true     |
| password        | character varying        | string (max length 255) | true     |
| role            | user_role_enum           | string                  | true     |
| email           | character varying        | string (max length 100) | true     |
| created_at      | timestamp with time zone | string                  | false    |
| created_by      | uuid                     | uuid                    | false    |
| last_updated_at | timestamp with time zone | string                  | false    |
| last_updated_by | uuid                     | uuid                    | false    |
| status          | user_status_enum         | string                  | true     |
| emp_id          | character varying        | string (max length 20)  | false    |
